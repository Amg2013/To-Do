              ...
              child: Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final task = listToSearch[index] as Task;
                        return MyWidget1(
                          description: listToSearch[index].description,
                          id: listToSearch[index].id,
                          titel: listToSearch[index].title,
                          task: state.allTasks.first,
                          isLight: true,
                        );
                      })),
            ));
